xmlport 50016 "RTB Line 1000"
{
    Direction = Import;
    FieldDelimiter = '<None>';
    FieldSeparator = '~';
    FileName = 'C:\1000\RTBLine_Lakshmi kumaran & Sridharan.csv';
    Format = VariableText;
    ...
    schema
    {
        textelement(Root)
        {
            tableelement("Sales Line"; "Sales Line")
            {
                ...
                begin
                    //"Sales Line".Type:= "Sales Line".Type::"";//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //"<OtherDetail1>" := '';//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    "<OtherDetail2>" := '';//2021 Initialze to avoid Other detail 2 to get repeated 210513.
                    //"<txtDesc>" := '';//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //R_SL.VALIDATE("No.",'');//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //R_SL.VALIDATE("Line Amount",0);//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //R_SL.VALIDATE(Quantity,0);//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //"<SupportingBillNo>" := '';//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //VarSupportingBillDate := 0D;//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //VarDateofExpense := 0D;//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //SalesHead."Shortcut Dimension 1 Code" := '';//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //SalesHead."Shortcut Dimension 2 Code" := '';//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    //R_SL.VALIDATE("Unit Price",0);//2021 Initialze to avoid Other detail 2 to get repeated 220713.
                    /*
