page 50027 "RTB CHANDIGARH List"
{
    CardPageID = "RTB CHANDIGARH";
    PageType = List;
    UsageCategory = Lists;
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                //field("Amount to Customer"; Rec."Amount to Customer")//TBD
    ...
    trigger OnOpenPage()
    begin
        Rec.SetRange(Rec."Location Code", 'CHANDIGARH');
        Rec.SetRange(Rec.Cancelled, false);
    end;
}
