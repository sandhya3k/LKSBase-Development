page 50037 "Accounting Mgr Role Cente"
{
    // <changelog>
    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Invoice Detail-XML")
            {
                Caption = 'Invoice Detail-XML';
                RunObject = Report "Invoice Detail-XML";
            }
            action("Credit Memo Detail-XML")
            {
                Caption = 'Credit Memo Detail-XML';
                RunObject = Report "Credit Memo Detail-XML";
            }
            action("Cancelled Credit Memo-XM")
            {
                Caption = 'Cancelled Credit Memo-XM';
                RunObject = Report "Cancelled Credit Memo-XML";
            }
            action("Cancelled RTB-XML")
            {
                Caption = 'Cancelled RTB-XML';
                RunObject = Report "Cancelled RTB-XML";
            }
            action("Credit Memo New")
            {
                Caption = 'Credit Memo New';
                RunObject = Report "Credit Memo New";
            }
            action("Posted sales Invoice PDF")
            {
                Caption = 'Posted sales Invoice PDF';
                RunObject = Report "Posted sales Invoice PDF";
            }
            action("Inv. Outstanding1000")
            {
                Caption = 'Inv. Outstanding1000';
                RunObject = XMLport "Inv. Outstanding1000";
            }
        }
        area(embedding)
