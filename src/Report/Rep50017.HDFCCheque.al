report 50017 "HDFC Cheque"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './res/HDFCCheque.rdlc';
    Caption = 'Check';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
                    ...
                    begin
                        ...
                        if not TestPrint then begin
                            with GenJnlLine do begin
                                ...
                                //MESSAGE('%1',CheckLedgEntry."Check No.");
                    ...
                    if not TestPrint then begin
                        if UseCheckNo <> GenJnlLine."Document No." then begin
                            ...
                            if not GLSetup."Activate Cheque No." then begin
                                ...
                                GenJnlLine3.SetRange("Cheque No. 2", UseCheckNo);
                                if GenJnlLine3.Find('-') then
                                    GenJnlLine3.FieldError("Cheque No. 2", StrSubstNo(Text013, UseCheckNo));
                            end;
                        end;
                    end;
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    //2021  TESTFIELD("Bal. Account Type","Bal. Account Type"::"Bank Account");
    ...
    begin
        ...
        if CurrencyCode <> '' then begin
            ...
            AddToNoText(NoText, NoTextIndex, PrintExponent, ' ');//3k-UPD
        end else
