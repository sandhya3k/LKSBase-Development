report 50165 "Customer Detailed Aging Email"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/CustomerDetailedAgingEmail.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                DataItemTableView = SORTING(Open, OWNER2, "Posting Date") ORDER(Ascending);
