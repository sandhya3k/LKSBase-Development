report 50060 "Credit Notes(Excel)"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Credit Notes(Excel)';
    DefaultLayout = RDLC;
    RDLCLayout = './res/CreditNotesExcel.rdlc';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(Inv_Amt_Billi_Curr; -Inv_Amt_Billi_Curr)
            {
            }
            ...
            begin
                ...
                */
                ...
                CustLedger.Reset;
                CustLedger.SetRange(CustLedger."Document No.", "Sales Cr.Memo Header"."No.");
                if CustLedger.FindFirst then
                    GroupHead := CustLedger."Group Heade";
            end;
