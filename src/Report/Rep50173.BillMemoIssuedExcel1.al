report 50173 "Bill/Memo Issued (Excel)1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/BillMemoIssuedExcel1.rdlc';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                if "Sales Invoice Header"."Ship-to Code" <> '' then begin
                    ShiptoAddress.Reset;
                    ShiptoAddress.SetRange("Customer No.", "Sales Invoice Header"."Sell-to Customer No.");
                    ShiptoAddress.SetRange(Code, "Sales Invoice Header"."Ship-to Code");
                    if ShiptoAddress.FindFirst then
                        Ship_GSTIN := ShiptoAddress."GST Reg No."
                    else
                        Ship_GSTIN := '';
                end;
                //MESSAGE(FORMAT(Ship_GSTIN));
                //Contactname:='';
                Cont.Reset;
