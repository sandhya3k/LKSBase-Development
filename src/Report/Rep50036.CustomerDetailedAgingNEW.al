report 50036 "Customer Detailed Aging (NEW)"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './res/CustomerDetailedAgingNEW.rdlc';
    ...
    var
        ...
        OWNER_2: Text[50];
        SubGrpName: Text[50];
        FilterTypeGlobal: Option " ",Owner2,GroupHead,SubGroup;
    ...
    procedure SetFilter(FilterType: Option " ",Owner2,GroupHead,SubGroup; Owner2Local: Code[30]; GroupHeadLocal: Code[30]; SubGroupLocal: Code[30]; StartDateLocal: Date; EndDateLocal: Date; EndDateLimitLocal: Date)
    begin
