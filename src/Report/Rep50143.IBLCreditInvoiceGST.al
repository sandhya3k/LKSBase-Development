report 50143 "IBL Credit Invoice GST"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/IBLCreditInvoiceGST.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Cr.Memo Header")
        {
            ...
            //TBD column(AmounttoCustomer_SalesInvoiceHeader; "Sales Invoice Header"."Amount to Customer")
            column(AmounttoCustomer_SalesInvoiceHeader; 0)
            {
            }
            ...
            column(BillDescription_SalesInvoiceHeader; "Sales Invoice Header"."Bill Description")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Invoice_Header___Ship_to_Address________Sales_Invoice_Header___Ship_to_Address_2_; "Sales Invoice Header"."Sell-to Address" + ' ' + "Sales Invoice Header"."Sell-to Address 2")
                    {
                    }
                    ...
                    column(Sales_Invoice_Header___Post_Office_______Sales_Invoice_Header___Ship_to_City______PinCode1; "Sales Invoice Header"."Ship-to Post Code" + ' ' + "Sales Invoice Header"."Ship-to City")
                    {
                    }
                    column(STNo; STNo)
                    {
                        ...
                        begin
                            ...
                            */
                            ...
                            if SnoNew = "Sales Invoice Line".Count then begin
                                ...
                                CheckReport.FormatNoText(NumberText, Round(LineTotAmt + Abs(IGSTAmt) + Abs(CGSTAmt) + Abs(SGSTAmt), 1), "Sales Invoice Header"."Currency Code");
                                //PANDU CheckReport.FormatNoText(NumberText, Round(LineTotAmt, 1), "Sales Invoice Header"."Currency Code");
            ...
            begin
                ...
                */
                ...
                if ShiptoAddress.FindFirst then begin
                    ...
                    StateDesc := "Sales Invoice Header"."State Name";
