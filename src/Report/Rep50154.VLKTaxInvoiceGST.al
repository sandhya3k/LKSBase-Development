report 50154 "VLK Tax Invoice GST"
{
    ...
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './res/VLKTaxInvoiceGST.rdlc';
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            */
                            ...
                            CheckReport.FormatNoText(NumberText, Round(LineTotAmt + IGSTAmtVar + SGSTAmtVar + CGSTAmtVar, 1), "Sales Invoice Header"."Currency Code");
    ...
    var
        ...
        KINDLY_PAY_IN_FAVOUR_OF__LAKSHMI_KUMARAN___SRIDHARAN__Lbl: Label 'KINDLY PAY IN FAVOUR OF ''V. LAKSHMIKUMARAN'' AND QUOTE THIS INVOICE NO. WHILE MAKING PAYMENT';
        place1: Decimal;
        ...
        Account_No__00322260000031: Label 'NOTE:Direct remittance Details - Account No. 00322260000014 with HDFC BANK C-5/32 SAFDARJUNG DEVELOPMENT AREA, NEW DELHI - 110016, INDIA, Account Type - Current, MICR - 1 1 0240004  IFSC Code HDFC0000032. The name of the account holder is V. Lakshmikumaran';
        "--2021--": Integer;
