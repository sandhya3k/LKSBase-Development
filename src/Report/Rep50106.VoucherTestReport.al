report 50106 "Voucher Test Report"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = './res/VoucherTestReport.rdlc';
        ...
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Gen. Journal Line"; "Gen. Journal Line")
                {
                    ...
                    column(Gen__Journal_Line__Amount__LCY__; "Amount (LCY)" - TDSAmount - 0 + TCSAmount + TCSAmountApplied + BankChargeAmt)
                    {
                    }
