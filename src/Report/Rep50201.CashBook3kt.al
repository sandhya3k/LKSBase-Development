report 50201 "Cash Book 3kt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/CashBook.rdl';
    Caption = 'Cash Book 3kt';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem("G/L Entry"; "G/L Entry")
            {
                ...
                column(Location_Code_GLEntry; "Location Code")
                { }
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    column(GLEntryLocCode; GLEntry."Location Code")
                    { }
            ...
            begin
                ...
                if AccountNo <> "No." then begin
                    ...
                    GLEntry2."Global Dimension 2 Code", GLEntry2."Close Income Statement Dim. ID", GLEntry2."Posting Date", "Location Code");
                    GLEntry2.SetRange(GLEntry2."G/L Account No.", "G/L Account"."No.");
            ...
            begin
                ...
                IF LocationCode <> '' THEN BEGIN
                    VouAccDebit.SETRANGE("Location code", LocationCode);
                    LocationFilter := 'Location Code: ' + LocationCode;
                end;
                VouAccDebit.SETFILTER(Type, '%1|%2', VouAccDebit.type::"Cash Payment Voucher",
                VouAccDebit.Type::"Cash Receipt Voucher");
                VouAccDebit.SETRANGE("Account Type", VouAccDebit."Account Type"::"G/L Account");

                if LocationCode <> '' THEN BEGIN
                    VouAccCredit.SETRANGE("Location code", LocationCode);
                    LocationFilter := 'Location Code: ' + LocationCode;

                END;
                VouAccCredit.SETFILTER(Type, '%1|%2', VouAccCredit.type::"Cash Payment Voucher",
                   VouAccCredit.Type::"Cash Receipt Voucher");
                VouAccCredit.SETRANGE("Account Type", VouAccCredit."Account Type"::"G/L Account");
    ...
    var
        ...
        VouAccDebit: Record "Voucher Posting Debit Account";
        VouAccCredit: Record "Voucher Posting Credit Account";
