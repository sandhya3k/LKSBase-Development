report 50010 "MEMO OF FEES WITH S.T."
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/MEMOOFFEESWITHST.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(DataItem1000000035; NOTE___Please_note_Service_Tax__of_NotifiLbl)
            {
            }
            column(DataItem1000000040; KINDLY_PAY_IN_FAVOUR_OF_Control1000000040Lbl)
            {
            }
            ...
            column(DataItem1000000022; NOTE_Please_remit_to_Account_No__00322440000056_with_HDFC_BANK_C_5_SAFDARJUNG_DEVELOPMENT_AREA__Lbl)
            {
            }
            column(TOTALCaption_Control1000000054; TOTALCaption_Control1000000054Lbl)
            {
            }
            column(DataItem1000000055; KINDLY_PAY_IN_FAVOUR_OF_Control1000000055Lbl)
            {
            }
            column(PAN_NO_Caption_Control1000000089; PAN_NO_Caption_Control1000000089Lbl)
            {
            }
            column(DataItem1000000091; NOTE_Please_remit_to_Account_No__00322260000031_with_HDFC_BANK_C_5_SAFDARJUNG_DEVELOPMENT_AREA__Lbl)
            {
            }
            column(TOTALCaption_Control1000000093; TOTALCaption_Control1000000093Lbl)
            {
            }
            column(DataItem1000000094; KINDLY_PAY_IN_FAVOUR_OF_Control1000000094Lbl)
            {
            }
            column(DataItem1000000000; NOTE___Please_note_Service_Tax__of_NotifiLbl)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Invoice_Header__District_______Sales_Invoice_Header___State_Name_______Sales_Invoice_Header__Country; "Sales Invoice Header".District + '  ' + "Sales Invoice Header"."State Name" + ' ' + "Sales Invoice Header".Country)
                    {
                    }
                    column(Sales_Invoice_Header___Shortcut_Dimension_2_Code_; "Sales Invoice Header"."Shortcut Dimension 2 Code")
                    {
                    }
                    column(Sales_Invoice_Header___Post_Office_______Sales_Invoice_Header___Ship_to_City______PinCode1; "Sales Invoice Header"."Post Office" + ' ' + "Sales Invoice Header"."Ship-to City" + ' ' + PinCode1)
                    {
                    }
                    column(STNo; STNo)
                    {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(Service_Tax_______ServiceTaxPer; 'Service Tax' + '  ' + ServiceTaxPer)
                        {
                            AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
    ...
    var
        ...
        Phone: Text[30];
        Text7: Text[30];
        ServiceTaxPer: Text[30];
        ServiceTaxECessPer: Decimal;
        ServiceTaxSHECessPer: Decimal;
        ...
        KINDLY_PAY_IN_FAVOUR_OF_Control1000000040Lbl: Label 'KINDLY PAY IN FAVOUR OF ''LAKSHMI KUMARAN & SRIDHARAN'' AND QUOTE THIS MEMO NO. WHILE MAKING PAYMENT';
        TOTALCaption_Control1000000045Lbl: Label 'TOTAL';
        PAN_NO_Caption_Control1000000015Lbl: Label 'PAN NO:';
        NOTE_Please_remit_to_Account_No__00322440000056_with_HDFC_BANK_C_5_SAFDARJUNG_DEVELOPMENT_AREA__Lbl: Label 'NOTE:Please remit through Telegraphic Transfer to Account No. 00322440000056 with HDFC BANK C-5 SAFDARJUNG DEVELOPMENT AREA, NEW DELHI - 110016, INDIA SWIFT CODE : HDFC INBB. The name of the account holder is LAKSHMI KUMARAN AND SRIDHARAN';
        TOTALCaption_Control1000000054Lbl: Label 'TOTAL';
        KINDLY_PAY_IN_FAVOUR_OF_Control1000000055Lbl: Label 'KINDLY PAY IN FAVOUR OF ''LAKSHMI KUMARAN & SRIDHARAN'' AND QUOTE THIS MEMO NO. WHILE MAKING PAYMENT';
        PAN_NO_Caption_Control1000000089Lbl: Label 'PAN NO:';
        NOTE_Please_remit_to_Account_No__00322260000031_with_HDFC_BANK_C_5_SAFDARJUNG_DEVELOPMENT_AREA__Lbl: Label 'NOTE:Please remit through Telegraphic Transfer to Account No. 00322260000031 with HDFC BANK C-5 SAFDARJUNG DEVELOPMENT AREA, NEW DELHI - 110016, INDIA SWIFT CODE : HDFC INBB. The name of the account holder is LAKSHMI KUMARAN AND SRIDHARAN';
        TOTALCaption_Control1000000093Lbl: Label 'TOTAL';
        KINDLY_PAY_IN_FAVOUR_OF_Control1000000094Lbl: Label 'KINDLY PAY IN FAVOUR OF ''LAKSHMI KUMARAN & SRIDHARAN'' AND QUOTE THIS MEMO NO. WHILE MAKING PAYMENT';
