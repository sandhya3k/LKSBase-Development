report 50202 "Bank Book 3KT"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/BankBook.rdl';
    Caption = 'Bank Book 3KT';
        ...
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            dataitem(DataItem4920; "Bank Account Ledger Entry")
            {
                ...
                dataitem("G/L Entry"; "G/L Entry")
                {
                    ...
                    { }
                    column(Location_Code_G_L_Entry; "Location Code")
                    { }
                    ...
                    dataitem(DataItem5444; Integer)
                    {
                        ...
                        column(GLEntry__Loc_Code; GLEntry."Location Code")
                        { }
            ...
            begin
                ...
                if BankAccountNo <> "No." then begin
                    ...
                    IF LocationCode <> '' THEN
                        BankAccountLedgerEntry.SETFILTER("Location Code", LocationCode);
            ...
            begin
                ...
                END;
                VouAccDebit.SETFILTER(type, '%1|%2',
                  VouAccDebit.Type::"Bank Payment Voucher",
                  VouAccDebit.Type::"Bank Receipt Voucher");
                VouAccDebit.SETRANGE("Account Type", VouAccDebit."Account Type"::"Bank Account");
                ...
                IF LocationCode <> '' THEN BEGIN
                    ...
                    LocationFilter := 'Location Code: ' + LocationCode;
                END;
                VouAccCredit.SETFILTER(type, '%1|%2',
                  VouAccCredit.Type::"Bank Payment Voucher",
                  VouAccCredit.Type::"Bank Receipt Voucher");
                VouAccCredit.SETRANGE("Account Type", VouAccCredit."Account Type"::"Bank Account");
