report 50040 "MEMO OF FEES VS-F3-New"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/MEMOOFFEESVSF3New.rdlc';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DataItem1000000013; 'Dist-' + "Sales Invoice Header".District + '  ' + "Sales Invoice Header"."State Name" + '  ' + "Sales Invoice Header"."Sell-to Country/Region Code")
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(category_services; Category)
                        {
                        }
                        column(Text1; Text1)
                        {
