report 50182 "TEST MEMO FEES S.T."
//PAN UPG Rename from 60002 to 50182
{
    ...
    //                                            -AHD-TRA or AHW-TRA
    // //EISINT-0803.E-240.EISINT ILG-085#29/05/05 -changes made to enable the flow of Security Filters in the S&R Reports.
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/TESTMEMOFEESST.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(Sales_Invoice_Header__Sales_Invoice_Header___Ship_to_Contact_; "Sales Invoice Header"."Ship-to Contact")
            {
            }
            ...
            column(Sales_Invoice_Header__Sales_Invoice_Header___Ship_to_Address_; "Sales Invoice Header"."Ship-to Address")
            {
            }
            column(Sales_Invoice_Header__Sales_Invoice_Header___Ship_to_Address_2_; "Sales Invoice Header"."Ship-to Address 2")
            {
            }
            column(CityN_________PinCode1; CityN + '  -  ' + PinCode1)
            {
            }
            column(Sales_Invoice_Header__Sales_Invoice_Header__State; "Sales Invoice Header".State)
            {
            }
            ...
            column(DataItem1000000039; NOTE_Please_remit_to_Account_No__00322430000225_with_HDFC_BANK_C_5_SAFDARJUNG_DEVELOPMENT_AREA__Lbl)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(Sales_Invoice_Line___Other_Detail_1______Sales_Invoice_Line___Other_Detail_2_; "Sales Invoice Line"."Other Detail 1" + '' + "Sales Invoice Line"."Other Detail 2")
                        {
                        }
                        ...
                        column(ServiceTaxAmt; Round(ServiceTaxAmt, 1))
                        {
                            AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(ServiceTaxECessAmt; Round(ServiceTaxECessAmt, 1))
                        {
                            AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(ServiceTaxSHECessAmt; Round(ServiceTaxSHECessAmt, 1))
                        {
                            AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
