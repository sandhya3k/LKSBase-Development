report 50159 "Mail Bill To Sub Group Head"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    //RDLCLayout = './res/MailBillToSubGroupHead.rdlc';
    ProcessingOnly = true;
    dataset
    {
        dataitem("Dimension Value"; "Dimension Value")
        {
            DataItemTableView = WHERE("Dimension Code" = FILTER('SUBGRP-OWNER2'));
            ...
            begin
                ...
                'Billing Including Credit Note Report for the period from ' + ' ' + FORMAT(DateFilter1) + ' to ' + ' ' + FORMAT(EndingDate) + ' ' + 'updated' + ' until yesterday', '', TRUE);

                EmailMessage.AppendToBody('Dear Sir/Madam,');
                EmailMessage.AppendToBody('<br><br>');
                EmailMessage.AppendToBody('Bills and CRN Group Wise Report is attached for the Bills and Credit Notes Generated for the period from' + ' ' +
                ...
                //TBD
                /*
                ReportRun.SaveAsExcel('C:\Bill_CRN_SubGroupHead_Wise\' + "Dimension Value".Name + '.xls');

                FileRec.Reset;
                FileRec.SetRange(Path, 'C:\Bill_CRN_SubGroupHead_Wise\');
                ...
                if FileRec.FindFirst then begin
                    ...
                    SmtpSend.AppendBody('Bills and CRN Group Wise Report is attached for the Bills and Credit Notes Generated for the period from' + ' ' +
                                          Format(DateFilter1) + ' to ' + Format(EndingDate) + ' ' + 'under your group as ' + "Dimension Value".Name);
                    SmtpSend.AppendBody('<br><br>');
                    ...
                    SmtpSend.AddAttachment('C:\Bill_CRN_SubGroupHead_Wise\' + "Dimension Value".Name + '.xls', '');
                    SmtpSend.Send;
                end
                */
