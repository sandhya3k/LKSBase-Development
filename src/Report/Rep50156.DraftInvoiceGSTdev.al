report 50156 "Draft Invoice GST(dev)"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/DraftInvoiceGSTdev.rdlc';

    Caption = 'MEMO OF FEES (GST)';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        column(GstBaseValue; "Sales Line"."Line Amount")
                        {
                        }
                        ...
                        begin
                            ...
                            */
                            ...
                            CheckReport.FormatNoText(NumberText, Round(LineTotAmt + Abs(IGSTAmountVar) + Abs(CGSTAmountVar) + Abs(SGSTAmountVar), 1), "Sales Header"."Currency Code");
            ...
            begin
                if Rental = true then begin
                    ...
                    if CommercialBollean = true then begin
                        HSNDESC := '9992';
                        CategoryDesc := 'Commercial training and coaching services';
                        HideVar := true;
                    end
                    else begin
