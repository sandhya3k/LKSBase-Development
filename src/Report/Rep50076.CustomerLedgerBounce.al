report 50076 "Customer Ledger(Bounce)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/CustomerLedgerBounce.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Detailed Cust. Ledg. Entry"; "Detailed Cust. Ledg. Entry")
            {
                ...
                column(PayAmtFC_Control1000000064; PayAmtFC)
                {
                }
                column(PayAmt_Control1000000065; PayAmt)
                {
                }
                ...
                column(PayAmt_Control1000000057; PayAmt)
                {
                }
                ...
                begin
                    ...
                    /*TCPL-2021 Block Code as bounce entry was missing--Begin--
                    IF (("Document Type"="Document Type"::Payment) AND (("Initial Document Type"="Initial Document Type"::Invoice))
                      AND (Unapplied = FALSE)) OR (("Document Type"="Document Type"::"Credit Memo")AND("Entry Type"="Entry Type"::"Initial Entry"))
                        THEN
                        BEGIN
                        PayDocDate :="Posting Date";
                       "PayDocType.":="Document Type";
                    TCPL-2021 Block Code as bounce entry was missing--End--*/


                    if (("Document Type" = "Document Type"::Payment) and (("Initial Document Type" = "Initial Document Type"::Invoice))
                      and (Unapplied = false)) or (("Document Type" = "Document Type"::"Credit Memo") and ("Entry Type" = "Entry Type"::"Initial Entry"))
                      or ("Journal Batch Name" = 'BOUNCE')
                        then begin
                        PayDocDate := "Posting Date";
                        "PayDocType." := "Document Type";
