report 50114 "HDFC LEAFE NEW"
{
    // //TEAM::1426/01 -28/04/2010 Code Added for Amount Print Service Tax amount on check Printing.
    DefaultLayout = RDLC;
    RDLCLayout = './res/HDFCLEAFENEW.rdlc';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    column(GenJnlLine__Posting_Date_; GenJnlLine."Posting Date")
                    {
                    }
                    ...
                    begin
                        if not TestPrint then begin
                            with GenJnlLine do begin
                                ...
                                CheckLedgEntry."Cheque No. 2" := UseCheckNo; //#94
                                // CheckLedgEntry."Document No." := UseCheckNo;
                                // CheckLedgEntry.Description := Description;
                                CheckLedgEntry."Description 3 " := "Description 3 ";//#122
                                ...
                                if FoundLast then begin
                                    ...
                                    //TBD
                                    /*
                                    CheckLedgEntry.Amount := TotalLineAmount + GenJnlLine."Service Tax Amount" + GenJnlLine."Service Tax eCess Amount" +
                                    GenJnlLine."Service Tax SHE Cess Amount" - TDSAmount - WorkTaxAmount;
                                    */
                                    CheckLedgEntry.Amount := TotalLineAmount - TDSAmount - WorkTaxAmount;//3k-UPG                                                                        
                                    //TEAM::1426/01
                                end else begin
                ...
                begin
                    if not TestPrint then begin
                        ...
                        if ApplyMethod <> ApplyMethod::MoreLinesOneEntry then begin
                            ...
                            //    GenJnlLine3."Document No." := UseCheckNo;//TEAM::1426
                           ...
                           END;  */
                            ...
                            if BalancingType <> BalancingType::"G/L Account" then
                                //GenJnlLine3.Description := StrSubstNo(Text014, SelectStr(BalancingType + 1, Text062), BalancingNo);
                             GenJnlLine3."Description 3 " := StrSubstNo(Text014, SelectStr(BalancingType + 1, Text062), BalancingNo);//#122
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    case BalancingType of
                        //2021 Because Pay to added into cheque for everyoption**start**
                        BalancingType::"G/L Account":
                            begin
                        ...
                        */
                        BalancingType::"Fixed Assets":
                            begin
                                // CheckToAddr[1] := GenJnlLine.Description;
                                CheckToAddr[1] := GenJnlLine."Description 3 ";
                            end;
                        BalancingType::"IC Partner":
                            begin
                                // CheckToAddr[1] := GenJnlLine.Description;
                                CheckToAddr[1] := GenJnlLine."Description 3 "
                            end;
                    ...
                    //2021 Because Pay to added into cheque for everyoption**End**
                    ...
                    */
                    ...
                    CheckDateText := Format("Posting Date", 0, '<Day> <Month Text>, <Year4>');
                end else begin
    ...
    var
        ...
        Text011: Label 'XXXX';
        Text012: Label 'XX.XXXXXXXXX.XXXX';
        ...
        CheckToAddr: array[8] of Text[1024];
        OnesText: array[20] of Text[30];
        TensText: array[10] of Text[30];
        ExponentText: array[5] of Text[30];
        BalancingType: Option "G/L Account",Customer,Vendor,"Bank Account","Fixed Assets","IC Partner";
        BalancingNo: Code[20];
        ContactText: Text[30];
        CheckNoText: Text[30];
