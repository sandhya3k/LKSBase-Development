report 50093 "DepositSlip HDFC=HDFC-Hyd"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './res/DepositSlipHDFCHDFCHyd.50093.rdlc';

    dataset
    {
        dataitem("Collection Detail"; "Collection Detail")
        {
            DataItemTableView = WHERE("Client Bank Name" = FILTER('*HDFC*'), Location = FILTER('HYDERABAD'), "On Submit Receipt No." = FILTER(<> ''));
