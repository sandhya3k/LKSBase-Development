report 50142 "Mail Bill To Group Head"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    //RDLCLayout = './res/MailBillToGroupHead.rdlc';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("Dimension Value"; "Dimension Value")
        {
            ...
            begin
                ...
                //TBD
                /*
                ReportRun.SaveAsExcel('C:\Bill_CRN_GroupHead_Wise\' + "Dimension Value".Name + '.xls');

                FileRec.Reset;
                FileRec.SetRange(Path, 'C:\Bill_CRN_GroupHead_Wise\');
                ...
                if FileRec.FindFirst then begin
                    ...
                    SmtpSend.AddAttachment('C:\Bill_CRN_GroupHead_Wise\' + "Dimension Value".Name + '.xls', '');
                    SmtpSend.Send;
                end
                */
