report 50158 "Mail To Sub-Group Owner"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    //RDLCLayout = './res/MailToSubGroupOwner.rdl';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("Dimension Value"; "Dimension Value")
        {
            ...
            begin
                ReportRun.Setfilters(DateFilter1, EndingDate, "Dimension Value".Code, "Dimension Value".Code, true);
                //3K
                ...
                //TBD
                /*
                ReportRun.SaveAsExcel('C:\Subgrp Owner2 Collection\' + "Dimension Value".Name + '.xls');

                FileRec.Reset;
                FileRec.SetRange(Path, 'C:\Subgrp Owner2 Collection\');
                ...
                if FileRec.FindFirst then begin
                    ...
                    SmtpSend.AddAttachment('C:\Subgrp Owner2 Collection\' + "Dimension Value".Name + '.xls', '');
                    SmtpSend.Send;
                end
                */
