report 50075 "Cancelled RTB-XML"
{
    ProcessingOnly = true;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = WHERE(Cancelled = FILTER(true), "Document Type" = FILTER(Invoice));
            ...
            begin
                ...
                //CustXmlFile.CREATE('D:\CancelledRTB'+"Sales Header"."No."+'.csv');
                //TBD
                /*
                CustXmlFile.Create('C:\' + "Sales Header"."No." + '.csv');
                CustXmlFile.CreateOutStream(XmlStream);
                XMLPORT.Export(50083, XmlStream, VarRec);
                CustXmlFile.Close;
                */
            end;
