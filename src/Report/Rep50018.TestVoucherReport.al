report 50018 "Test Voucher Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/TestVoucherReport.rdlc';
        ...
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Gen. Journal Line"; "Gen. Journal Line")
                {
                    ...
                    column(Gen__Journal_Line__Amount__LCY__; "Amount (LCY)" - TDSAmount - 0 + TCSAmount + TCSAmountApplied)
                    {
                    }
                    ...
                    column(TDS_Amount_Including_eCessCaption; TDS_Amount_Including_eCessCaptionLbl)
                    {
                    }
                    column(Work_Tax_AmountCaption; Work_Tax_AmountCaptionLbl)
                    {
                    }
                    ...
                    dataitem(DimensionLoop; "Integer")
                    {
                        ...
                        begin
                            ...
                            */
                            ...
                            //TEAM::1426
                            LedgerDim.RESET;
                            LedgerDim.SETRANGE(LedgerDim."Table ID",81);
                            LedgerDim.SETRANGE(LedgerDim."Journal Template Name","Gen. Journal Line"."Journal Template Name");
                            LedgerDim.SETRANGE(LedgerDim."Journal Batch Name","Gen. Journal Line"."Journal Batch Name");
                            LedgerDim.SETRANGE(LedgerDim."Journal Line No.","Gen. Journal Line"."Line No.");
                            IF LedgerDim.FIND('-') THEN BEGIN
                            REPEAT
                                   IF (LedgerDim."Dimension Code"='BRANCH') OR(LedgerDim."Dimension Code"='EMPLOYEE')
                                     OR (LedgerDim."Dimension Code"='TELEPHONE')
                                       OR (LedgerDim."Dimension Code"='EMPL') OR (LedgerDim."Dimension Code"='DEPT') OR
                                          (LedgerDim."Dimension Code"='MTH-FY') OR (LedgerDim."Dimension Code"='VENDOR')
                                        OR (LedgerDim."Dimension Code"='CUSTOMER') OR (LedgerDim."Dimension Code"='REF-FIELD')
                                         OR (LedgerDim."Dimension Code"='COMMUNICATION') THEN
                            
                            //       ELSE
                            //       BEGIN
                            //       jnDim.RESET;
                            //       jnDim.SETRANGE(jnDim."Dimension Code",LedgerDim."Dimension Code");
                            //       jnDim.SETRANGE(jnDim.Code,LedgerDim."Dimension Value Code");
                            //       IF jnDim.FIND('-') THEN
                                    DimText:=DimText+' - '+jnDim.Name;
                        ...
                        begin
                            ...
                            JnlLineDim.SetRange("Journal Template Name", "Gen. Journal Line"."Journal Template Name");
                            JnlLineDim.SetRange("Journal Batch Name", "Gen. Journal Line"."Journal Batch Name");
                            JnlLineDim.SetRange("Journal Line No.", "Gen. Journal Line"."Line No.");
                            */
                        end;
                    }
                    ...
                    begin
                        ...
                        if not EmptyLine then begin
                            ...
                            */
                            ...
                            //TBD //JnlLineDim.SetRange("Table ID", DATABASE::"Gen. Journal Line");
                            //TBD
                            /*
                        ...
                        */
                        ...
                        if ExciseCenvatClaim.Get("Journal Template Name", "Journal Batch Name", "Line No.") then begin  //Bugfix
                            ...
                            ServiceTaxBuffer.SetCurrentKey("Document No.", "Same Group Set Off");
    ...
    var
        ...
        TDS_Amount_Including_eCessCaptionLbl: Label 'TDS Amount Including eCess';
        Work_Tax_AmountCaptionLbl: Label 'Work Tax Amount';
        ...
        with GenJnlLine do begin
            if not GLAcc.Get("Account No.") then
                ...
                if GLAcc."Reconciliation Account" then
                    ...
                    ReconcileGLAccNo("Account No.", Round(("Amount (LCY)") /
                      (1 + "VAT %" / 100)));
            end;
        end;
    end;
    ...
    begin
        with GenJnlLine do begin
            ...
            if "FA Posting Date" <> 0D then begin
                ...
                /*
                   IF NOT ("FA Posting Date" IN [01010002D..31129998D]) THEN
                     AddError(
                       STRSUBSTNO(
                         Text053,
                         FIELDCAPTION("FA Posting Date")));
