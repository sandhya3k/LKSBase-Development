report 50057 "Periodical collection-Mumbai"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/PeriodicalcollectionMumbai.rdlc';

    dataset
    {
        dataitem("Collection Detail"; "Collection Detail")
        {
            DataItemTableView = WHERE(Location = FILTER('MUMBAI'), "On Submit Receipt No." = FILTER(<> ''));
