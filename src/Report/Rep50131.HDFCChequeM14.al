report 50131 "HDFC Cheque-M14"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/HDFCChequeM14.rdlc';
    Caption = 'Check';
                ...
                begin
                    ...
                    if ApplyMethod <> ApplyMethod::MoreLinesOneEntry then begin
                        ...
                        if not GLSetup."Activate Cheque No." then begin
                            ...
                            //GenJnlLine3."Cheque No." := UseCheckNo; //team::1426
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    if ("Account Type" = "Account Type"::"Bank Account") and ("Account No." <> '') then begin
                        GenJnlLine5.Reset;
                        GenJnlLine5.SetCurrentKey("Journal Template Name", "Journal Batch Name", "Posting Date", "Document No.");
                        GenJnlLine5.SetRange(GenJnlLine5."Journal Template Name", "Journal Template Name");
                        GenJnlLine5.SetRange(GenJnlLine5."Journal Batch Name", "Journal Batch Name");
                        GenJnlLine5.SetRange(GenJnlLine5."Posting Date", "Posting Date");
                        GenJnlLine5.SetRange(GenJnlLine5."Document No.", "Document No.");
                        if GenJnlLine5.FindLast then
                            BalancingType := GenJnlLine5."Account Type";
                        BalancingNo := GenJnlLine5."Account No.";
    ...
    var
        ...
        CompanyAddr: array[8] of Text[75];
