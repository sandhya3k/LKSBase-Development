report 50152 "Draft Credit Note GST"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/DraftCreditNoteGST.rdlc';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            RequestFilterHeading = 'Draft Credit note';
            column(LocStateName; LocStateName)
            {
            }
            column(LocationStateCode; LocationStateCode)
            {
            }
            ...
            column(BillDescription_SalesCrMemoHeader; "Bill Description")
            {
            }
            ...
            column(ShipAddress; "Sales Header"."Ship-to Address")
            {
            }
            column(ShipAddress1; ShipAddress1)
            {
            }
            column(ShipToCityVar; "Sales Header"."Ship-to City")
            {
            }
            column(StateName; "Sales Header".ShipToStateName)
            {
            }
            column(ShipToPostcodeVar; "Sales Header"."Ship-to Post Code")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Invoice_Header___Ship_to_Address________Sales_Invoice_Header___Ship_to_Address_2_; "Sales Header"."Ship-to Address")
                    {
                    }
                    column(DataItem1000000013; ShipToCityVar + ' ' + ShiptoCity + ' ' + ShipToPostcodeVar)
                    {
                    }
                    column(Sales_Invoice_Header___Post_Office_______Sales_Invoice_Header___Ship_to_City______PinCode1; "Sales Header"."Post Office" + ' ' + ShiptoCity)
                    {
                    }
                    column(STNo; STNo)
                    {
                    ...
                    column(SalesHeaderCountry; "Sales Header".country)
                    {
                    }
                    column(SalesHeaderCurrency; "Sales Header"."Currency Code")
                    {
                    }
            ...
            begin
                ...
                */
                ...
                if ShiptoAddress.FindFirst then begin
                    ...
                    ShipAddress := ShiptoAddress."Client Address 1";
                    ShipAddress1 := ShiptoAddress."Client Address 2";
                    ShipToCityVar := ShiptoAddress."City Town";
                    //IF StatesRec.GET(ShiptoAddress.State) THEN
                    ShiptoCity := UpperCase(ShiptoAddress."State Name");
                    StatesRec.Reset;
                    ...
                    ShipToPostcodeVar := ShiptoAddress."Post Office";
                    //CityName := ShiptoAddress."State Name";
                end else begin
                    CountryName := "Sales Header"."Bill-to County";
                    ShipLocation := ShiptoAddress.Country;
                    RecipientGST := Cust."GST Reg No.";
                    ShipAddress := "Sales Header"."Bill-to Address";
                    ShipAddress1 := "Sales Header"."Bill-to Address 2";
                    ShipToCityVar := "Sales Header"."Bill-to City";
                    if StatesRec.Get("Sales Header".State) then
                        ShiptoCity := UpperCase(StatesRec.Description);
                    GSTStateCode := StatesRec."State Code (GST Reg. No.)";
                    ShipToPostcodeVar := "Sales Header"."Bill-to Post Code";
                end;
                //TEAM::2021--End--
                ...
                if StateLoc.Get(RecLocation."State Code") then;
                LocStateName := StateLoc.Description;
                //TBD //LocationStateCode := StateLoc."State Code for TIN";
                LocationStateCode := StateLoc."State Code (GST Reg. No.)";//3k-UPG
                State_Code := '';
                Clear(StateDesc);
                if REc_State.Get(ShiptoAddress.State) then begin
                    //TBD //State_Code := REc_State."State Code for TIN";
                    State_Code := REc_State."State Code (GST Reg. No.)";//3k-UPG
                    StateDesc := UpperCase(REc_State.Description);
                end;
                ...
                SaleInvHeader.Reset;
                SaleInvHeader.SetRange(SaleInvHeader."No.", "Sales Header"."Applies-to Doc. No.");
    ...
    var
        ...
        ShipToCityVar: Text[50];
        ShipToPostcodeVar: Code[10];
        GSTStateCode: Code[10];
        LocStateName: Text[20];
        LocationStateCode: Code[10];
        StateCodeVar: Text[100];
        CountryVar: Text[50];
