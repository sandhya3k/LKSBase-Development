report 50149 "Branch Tax Invoice GST"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/BranchTaxInvoiceGST.rdlc';
    ...
    var
        ...
        "VAT12.5": Decimal;
        Item1: Record Item;
        VATProdGroup: Code[10]; //3K 10 to 20
        VAT10: Decimal;
        VATText1: Text[1024];
        VATText2: Text[1024];
        VATText3: Text[1024];
        ...
        State_Code: Code[20]; //3k 10 to 20
        StateDesc: Text;
