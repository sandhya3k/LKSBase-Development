report 50176 "Credit Note GST Tax Logo"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/CreditNoteGSTTaxLogo.rdlc';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(LocationName; Name1)
            {
            }
            column(LocationName2; Name2)
            {
            }
            column(LocationAdd2; Address2)
            {
            }
            column(LocationAdd; Address1)
            {
            }
            column(PostCode1; PostCode1)
            {
            }
            column(LocPhone; Phone1)
            {
            }
            column(LocPhone2; Phone2)
            {
            }
            column(LocationCity; City1)
            {
            }
            ...
            column(Applied_Date; Format(AppliedDate))
            {
            }
            column(AppliedToText; AppliedToText)
            {
            }
            column(BillDescription_SalesCrMemoHeader; "Sales Cr.Memo Header"."Bill Description")
            {
            }
            ...
            column(QR_Sales; PostedSalesExt."QR Code")
            {
            }
            column(IRN_Sales; PostedSalesExt."IRN No.")
            {
            }
            ...
            column(ShipAddress; ShipAddress)
            {
            }
            column(ShipAddress1; ShipAddress1)
            {
            }
            column(ShiptoCity; ShiptoCity)
            {
            }
            column(ShiptoPos; ShiptoPos)
            {
            }
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Invoice_Header___No__; "Sales Cr.Memo Header"."No.")
                    {
                    }
                    column(FORMAT__Sales_Invoice_Header___Posting_Date__0___Day_2_____Month_Text____Year4___; Format("Sales Cr.Memo Header"."Posting Date", 0, '<Day,2>,  <Month Text>  <Year4>'))
                    {
                    }
                    column(Sales_Invoice_Header___Ship_to_Contact_; "Sales Cr.Memo Header"."Ship-to Contact")
                    {
                    }
                    column(Sales_Invoice_Header___Sell_to_Customer_Name________Sales_Invoice_Header___Sell_to_Customer_Name_2_; "Sales Cr.Memo Header"."Sell-to Customer Name" + ' ' + "Sales Cr.Memo Header"."Sell-to Customer Name 2")
                    {
                    }
                    column(Sales_Invoice_Header___Ship_to_Address________Sales_Invoice_Header___Ship_to_Address_2_; ShipAddress + '  ' + ShipAddress1)
                    {
                    }
                    column(DataItem1000000013; "Sales Cr.Memo Header".District + '  ' + "Sales Cr.Memo Header"."State Name" + '  ' + "Sales Cr.Memo Header"."Sell-to Country/Region Code")
                    {
                    }
                    column(Sales_Invoice_Header___Post_Office_______Sales_Invoice_Header___Ship_to_City______PinCode1; "Sales Cr.Memo Header"."Post Office" + ' ' + ShiptoCity)
                    {
                    }
                    column(STNo; STNo)
                    {
                    ...
                    column(Sales_Invoice_Header___Shortcut_Dimension_2_Code_; "Sales Cr.Memo Header"."Shortcut Dimension 2 Code")
                    {
                    }
                    ...
                    column(SalesCrCurrency; "Sales Cr.Memo Header"."Currency Code")
                    {
                    }
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        begin
                            ...
                            "Sales Cr.Memo Line".SetRange("Sales Cr.Memo Line"."Document No.", "Sales Cr.Memo Line"."Document No.");
                            //"Sales Invoice Line".SETRANGE("Tax Group Code","Sales Invoice Line"."Tax Group Code");
                            //TBD
                            /*
                            if ("Sales Cr.Memo Line"."Tax Group Code" = 'V-04') or ("Sales Cr.Memo Line"."Tax Group Code" = 'V-12.5') then
                                vatTax := vatTax + "Sales Cr.Memo Line"."Tax Amount";
                            if ("Sales Cr.Memo Line"."Tax Group Code" = 'C-04') or ("Sales Cr.Memo Line"."Tax Group Code" = 'C-02') or
                            ("Sales Cr.Memo Line"."Tax Group Code" = 'C-03') or ("Sales Cr.Memo Line"."Tax Group Code" = 'C-10') then
                                cstTax := cstTax + "Sales Cr.Memo Line"."Tax Amount";
                            */
                            ...
                            if StructureLineDetails.Find('-') then
                                repeat
                                    ...
                                    if StructureLineDetails."Tax/Charge Type" = StructureLineDetails."Tax/Charge Type"::"Service Tax" then begin
                                        ...
                                        if "Sales Cr.Memo Line"."VAT %" = 4.0 then
                                            VATFG := VATFG + StructureLineDetails.Amount
                                        else
                                            if "Sales Cr.Memo Line"."VAT %" = 12.5 then
                                                "VAT12.5" := "VAT12.5" + StructureLineDetails.Amount
                                            else
                                                if "Sales Cr.Memo Line"."VAT %" = 10.0 then
                            ...
                            */
                            ...
                            if "Sales Cr.Memo Line".Type = 1 then
                            ...
                            CheckReport.FormatNoText(NumberText, Round(LineTotAmt, 1), "Sales Cr.Memo Header"."Currency Code");
                ...
                begin
                    ...
                    LocationText := CopyStr("Sales Cr.Memo Header"."Location Code", 1, 3);
                    ...
                    if Location1.Get("Sales Cr.Memo Header"."Location Code") then begin
                        ...
                        */
                        ...
                        LocEmail := Location1."E-Mail";
                        LocCountry := Location1."Country/Region Code";
                    end;
            ...
            begin
                ...
                PostedSalesExt.SetRange("No.", "No.");
                if PostedSalesExt.FindFirst then;
                PostedSalesExt.CalcFields("QR Code");
                ...
                */
                ...
                //TBD //FormatAddr.SalesCrMemoShipTo(ShipToAddr, "Sales Cr.Memo Header");
                FormatAddr.SalesCrMemoShipTo(ShipToAddr, CustAddr, "Sales Cr.Memo Header"); //3k-UPG
                ...
                */
                //E-244 Added this code on 030905 to get City NamE
                CityN := "Sales Cr.Memo Header"."Ship-to City";
                PinCode1 := "Sales Cr.Memo Header"."Ship-to Post Code";
                PostOffice := "Sales Cr.Memo Header"."Post Office";



                ContactR.SetRange(ContactR."No.", "Sales Cr.Memo Header"."Bill-to Contact No.");
                ...
                ServiceTaxEntry.SetFilter(ServiceTaxEntry."Document Type", 'Credit Memo');
                ...
                */
                ...
                //TEAM::2021--Begin--
                ShiptoAddress.SetRange(ShiptoAddress."Customer No.", "Sales Cr.Memo Header"."Sell-to Customer No.");
                ShiptoAddress.SetRange(ShiptoAddress.Code, "Sales Cr.Memo Header"."Ship-to Code");
                if ShiptoAddress.FindFirst then begin
                    CountryName := ShiptoAddress.Country;
                    ShipLocation := ShiptoAddress."Location Code";
                    RecipientGST := ShiptoAddress."GST Reg No.";
                    ShipAddress := ShiptoAddress.Address;
                    ShipAddress1 := ShiptoAddress."Address 2";
                    ShiptoCity := ShiptoAddress."State Name";
                    ShiptoPos := ShiptoAddress."Post Office";
                    CityTown := ShiptoAddress."City Town";
                    StatesRec.Reset;
                    StatesRec.SetRange(Description, ShiptoAddress."State Name");
                    if StatesRec.FindFirst then
                        //TBD //GSTStateCode := StatesRec."State Code for TIN";
                        GSTStateCode := StatesRec."State Code (GST Reg. No.)";//3k-UPG
                ...
                //   MESSAGE('%1',State_Code);

                if "Applies-to Doc. No." = '' then
                    AppliedToText := ''
                else
                    AppliedToText := StrSubstNo(Text50000, "Applies-to Doc. Type", "Applies-to Doc. No.");
                ...
                REc_State.Reset;
                REc_State.SetRange(Description, ShiptoAddress."State Name");
                if REc_State.FindFirst then
                    //TBD //StateCodeVar := ShiptoAddress."State Name" + '-' + REc_State."State Code for TIN"
                    StateCodeVar := ShiptoAddress."State Name" + '-' + REc_State."State Code (GST Reg. No.)"//3k-UPG
                else
                    StateCodeVar := ShiptoAddress."State Name";

                CountryVar := ShiptoAddress.Country;

                if "Sales Cr.Memo Header"."Currency Code" <> '' then
                    if "Sales Cr.Memo Header"."Currency Code" <> 'INR' then
    ...
    begin
        GLSetup.Get;
        OptionMultiple := OptionMultiple::"ORIGINAL FOR RECIPIENT";
    end;
    ...
    var
        ...
        vatTax: Decimal;
        varr1: Decimal;
        slinvln: Record "Sales Cr.Memo Line";
        Sno: Text[1024];
        ...
        Desc1: Text[90];
        Desc2: Text[170];
        SaleInv: Record "Sales Cr.Memo Line";
        Desc3: Text[250];
        Desc4: Text[330];
        Desc5: Text[410];
        Desc6: Text[490];
        ...
        Account_No__00322430000225: Label 'NOTE:Please remit through Telegraphic Transfer to Account No. 00322430000225 with HDFC BANK C-5/32 SAFDARJUNG DEVELOPMENT AREA, NEW DELHI - 110016, INDIA SWIFT CODE : HDFC INBBXXX. The name of the account holder is LAKSHMI KUMARAN AND SRIDHARAN';
        ...
        place1: Decimal;
        Account_No__00322440000056: Label 'NOTE:Please remit through Telegraphic Transfer to Account No. 00322440000056 with HDFC BANK C-5/32 SAFDARJUNG DEVELOPMENT AREA, NEW DELHI - 110016, INDIA SWIFT CODE : HDFC INBBXXX. The name of the account holder is LAKSHMI KUMARAN AND SRIDHARAN';
        ...
        AppliedDate: Date;
        Text50000: Label 'Credit Note Against %1 No. %2';
        ShipAddress: Text;
        ShipAddress1: Text;
        ShiptoCity: Text;
        ShiptoPos: Code[10];
        GSTStateCode: Code[30];
        CityTown: Text[20];
        StateCodeVar: Code[50];
        CountryVar: Code[40];
