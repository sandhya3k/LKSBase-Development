report 50153 "IBL Tax Invoice GST"
{
    ...
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './res/IBLTaxInvoiceGST.rdlc';
    ...
    dataset
    {
        ...
        {
            //TBD //CalcFields = "Amount to Customer";
            ...
            column(LocationGSTIN; RecLocation."GST Registration No.")
            {
            }
                        ...
                        begin
                            ...
                            */
                            ...
                            if SnoNew = "Sales Invoice Line".Count then begin
                                ...
                                total_Cost := Round(LineTotAmt + Abs(IGSTAmt) + Abs(CGSTAmt) + Abs(SGSTAmt), 1);
            ...
            begin
                ...
                */
                ...
                if REc_State.Get(ShipLocation) then begin
                    ...
                    State_Code := REc_State."State Code (GST Reg. No.)";
