report 50096 "Periodical collection-Hyd"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/PeriodicalcollectionHyd.rdlc';

    dataset
    {
        dataitem("Collection Detail"; "Collection Detail")
        {
            DataItemTableView = WHERE(Location = FILTER('HYDERABAD'), "On Submit Receipt No." = FILTER(<> ''));
