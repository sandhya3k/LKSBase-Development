report 50029 "DepositSlip HDFC<>HDFC-Ahmed"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './res/DepositSlipHDFCHDFCAhmed.rdlc';

    dataset
    {
        dataitem("Collection Detail"; "Collection Detail")
        {
            DataItemTableView = WHERE("Client Bank Name" = FILTER(<> '*HDFC*'), Location = FILTER('AHMEDABAD'), Submitted = FILTER(true));
