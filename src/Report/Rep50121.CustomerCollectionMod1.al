report 50121 "Customer Collection Mod_1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/CustomerCollectionMod1.rdlc';
    Caption = 'Customer';
    // ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
        {
            ...
            begin
                ...
                "Cust. Ledger Entry".SetFilter("Posting Date", '%1', DateFilterNew);
            end;
        }
    }
    ...
    procedure Setfilters(DateFilter: Date; OwnerFilter: Code[20])
    begin
