report 50091 "Periodical collection-Chennai"
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/PeriodicalcollectionChennai.rdlc';

    dataset
    {
        dataitem("Collection Detail"; "Collection Detail")
        {
            DataItemTableView = WHERE(Location = FILTER('CHENNAI'), "On Submit Receipt No." = FILTER(<> ''));
