report 50023 "MEMO OF FEES1"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './res/MEMOOFFEES1.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(Sales_Invoice_Header___Currency_Code__Control1000000025; "Sales Invoice Header"."Currency Code")
                        {
                            AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
