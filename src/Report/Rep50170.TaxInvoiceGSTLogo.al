report 50170 "Tax Invoice GST Logo"
{
    ...
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './res/TaxInvoiceGSTLogo.rdlc';
            ...
            begin
                ...
                */
                ...
                if ShiptoAddress.FindFirst then begin
                    ...
                    ShiptoPostCode := "Sales Invoice Header"."Ship-to City" + ' ' + ShiptoAddress.District + ' ' + "Sales Invoice Header"."Ship-to Post Code" + ' ' + "Sales Invoice Header".ShipToStateName + ' ' + ShiptoAddress.Country;
                end;
                //TEAM::2021--End--
                ...
                */
                ...
                if REc_State.FindFirst then
                    //StateCodeVar := ShiptoAddress."State Name"+'-'+REc_State."State Code for TIN"
                ...
                if "Sales Invoice Header"."Currency Code" <> '' then
                    if "Sales Invoice Header"."Currency Code" <> 'INR' then
    ...
    var
        ...
        ShipToAddressVar: Text[250];
        ForiegnCountry: Text[100];
        LocEmail: Text[50];
        LocCountry: Text[20];
        ContactEmail: Text;
