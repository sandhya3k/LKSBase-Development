report 50002 INVOICE_VS
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(DataItem1000000018; Direct_remittance_Details_003Lbl)
            {
            }
            ...
            column(DataItem1000000022; Direct_remittance_Details_001Lbl)
            {
            }
            ...
            column(DataItem1000000091; Direct_remittance_Details_002Lbl)
            {
            }
            ...
            column(Account_No00322260000024; Account_No__00322260000024)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Invoice_Header___Ship_to_Contact_; "Sales Invoice Header"."Sell-to Contact")
                    {
                    }
                    ...
                    column(DataItem1000000013; "Sales Invoice Header".District + '  ' + "Sales Invoice Header"."State Name")
                    {
                    }

                    column(SalesInvoiceHeader_District_Sate_Region; "Sales Invoice Header".District + '  ' + "Sales Invoice Header"."State Name")
                    {
                    }
                    column(Sales_Invoice_Header___Post_Office_______Sales_Invoice_Header___Ship_to_City______PinCode1; "Sales Invoice Header"."Sell-to City" + '  ' + "Sales Invoice Header"."Sell-to Post Code" + '   ' + "Sales Invoice Header"."Sell-to Country/Region Code")
                    {
                    }
                    column(STNo; STNo)
                    {
    ...
    var
        ...
        Direct_remittance_Details_001Lbl: Label 'Direct remittance Details - Account No. 00322260000024 with HDFC BANK C-5 SAFDARJUNG DEVELOPMENT AREA, NEW DELHI - 110016, INDIA, Account Type - Current, MICR - 1 1 0240004  IFSC Code HDFC0000032. The name of the account holder is V. SRIDHARAN';
        ...
        Direct_remittance_Details_002Lbl: Label 'Direct remittance Details - Account No. 00322260000024 with HDFC BANK C-5 SAFDARJUNG DEVELOPMENT AREA, NEW DELHI - 110016, INDIA, Account Type - Current, MICR - 1 1 0240004  IFSC Code HDFC0000032. The name of the account holder is V. SRIDHARAN';
        Direct_remittance_Details_003Lbl: Label 'Direct remittance Details - Account No. 00322260000024 with HDFC BANK C-5 SAFDARJUNG DEVELOPMENT AREA, NEW DELHI - 110016, INDIA, Account Type - Current, MICR - 1 1 0240004  IFSC Code HDFC0000032. The name of the account holder is Lakshmi Kumaran & Sridharan';
