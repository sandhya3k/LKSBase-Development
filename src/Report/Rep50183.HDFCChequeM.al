report 50183 "HDFC Cheque-M"
//PAN UPG Rename from 60005 to 50183
{
    DefaultLayout = RDLC;
    RDLCLayout = './res/HDFCChequeM.rdlc';
    Caption = 'Check';
                    ...
                    if not TestPrint then begin
                        if UseCheckNo <> GenJnlLine."Document No." then begin
                            ...
                            if not GLSetup."Activate Cheque No." then begin
                                ...
                                GenJnlLine3.SetRange("Cheque No. 2", UseCheckNo); //#94
                                if GenJnlLine3.Find('-') then
                                    //GenJnlLine3.FieldError("Cheque No.", StrSubstNo(Text013, UseCheckNo));
                                    GenJnlLine3.FieldError("Cheque No. 2", StrSubstNo(Text013, UseCheckNo)); //#94
                            end;
                        end;
                    end;
