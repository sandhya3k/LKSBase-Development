table 50020 "TDS Information12"
{
    ...
    fields
    {
        ...
        field(5; "Bill No."; Text[30])
        {
            ...
            begin
                /*
                SalesInvHeader.GET("Client ID");
                Currency :=SalesInvHeader."Amount to Customer";
                */
        ...
        field(7; "Client No."; Code[20])
        {
            ...
            begin
                /*
                Cust.GET("Client Bank ID");
                "Client Bank Name"  :=Cust.Name;
                 "Client Bank City"       :=Cust.Address;
                 "Deposit Bank"          :=Cust.City;
                 "Bank Account Name"         :=Cust."State Code";
                 "Pin Code"    :=Cust."Post Code";
                 "Client Name"     :=Cust."P.A.N. No."
                 Code blocked since client id is not available
                 */
